...
def getOpenConnection(user='postgres', password='random', dbname='ddsassignment3'):
...
def loadRatings(ratingstablename, ratingsfilepath, openconnection):
    ...
    cur.execute("CREATE TABLE "+ratingstablename+" (UserID INT,MovieID INT ,  Rating REAL,Timestamp INT)")
    
    loadout = open(ratingsfilepath,'r')
    
    cur.copy_from(loadout,ratingstablename,sep = ':',columns=('UserID','MovieID','Rating','Timestamp'))
